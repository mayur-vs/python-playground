...
class Animal :
    ...
    def speak(self) : # defined speak method 1st time
...
# Method Overriding
# samjo Parent class mein - ABC name ka method define hua hain
# child class mein - parent class jo ABC name ka method define hua hain 
# same ussi name se method define karte hain child class method but different tarike se tab use method overriding kahte hain
class Dog(Animal) :
    def speak(self) :# defined speak method 2nd time
        print("Bark! Bark!")
